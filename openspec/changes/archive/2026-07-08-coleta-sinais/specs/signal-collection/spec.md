...
fonte de dados (repositório de imagens, base de apólices, histórico de sinistros). Estouro de timeout ou
circuito aberto MUST resultar no sinal correspondente marcado como "indisponível"
(motivo: fonte externa), sem retentativas que estourem o orçamento de SLA. Cada fonte
MUST permitir simular indisponibilidade via configuração, para demo e testes.
