# sinistro-idempotency Specification

## Purpose

Deduplicação de eventos de sinistro na ingestão: garante que o mesmo `idSinistro` nunca gere
duas entradas na fila de processamento, usando um store de deduplicação com janela de retenção
de 24h. A checagem é fail-open — sua indisponibilidade nunca bloqueia o enfileiramento do
sinistro.
