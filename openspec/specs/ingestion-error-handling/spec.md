# ingestion-error-handling Specification

## Purpose

Tratamento de erros na ingestão de sinistros: roteia eventos não-processáveis para uma fila de
erro técnico (DLQ) e aplica retry com backoff exponencial no enfileiramento diante de falhas
transitórias, garantindo que nenhum evento seja descartado silenciosamente nem que erros
técnicos afetem o produtor ou o sinistro no sistema principal.
