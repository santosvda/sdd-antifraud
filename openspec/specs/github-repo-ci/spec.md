# github-repo-ci Specification

## Purpose

Repositório remoto no GitHub e CI mínimo: repositório privado com `main` estável e deployável, fluxo de branches short-lived, e um workflow de GitHub Actions que roda `dotnet build` e `dotnet test` em cada pull request.
